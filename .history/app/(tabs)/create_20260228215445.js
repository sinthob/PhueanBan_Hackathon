        ...
        <Section title="รูปแบบกิจกรรม" description="เลือกว่าจะทำออนไลน์หรือเจอกันจริง">
          ...
          {activityMode === 'onsite' ? (
            <View style={styles.onsiteWrap}>
              ...
              >
                <Text style={styles.mapPreviewTitle}>แผนที่ (mock)</Text>
                <Text style={styles.mapPreviewBody}>
                  {onsiteLocation
                    ? `📍 ${onsiteLocation.label}`
                    : 'ยังไม่ได้เลือกตำแหน่ง (แตะที่แผนที่เพื่อเลือก)'}
                </Text>
              </Pressable>
              ...
              <TextInput
                ...
                placeholder="เช่น สวนลุมพินี / ศูนย์ชุมชน"
                placeholderTextColor={WarmClearTheme.colors.textMuted}
                style={styles.input}
              />
              ...
              <Pressable
                onPress={() => {
                  ...
                  Alert.alert('เลือกแล้ว (mock)', `ตั้งสถานที่เป็น “${trimmed}”`);
                }}
                accessibilityRole="button"
                accessibilityLabel="ยืนยันสถานที่จากการค้นหา"
                style={styles.mapPickButton}
              >
                <Text style={styles.mapPickButtonText}>ยืนยันสถานที่ (mock)</Text>
              </Pressable>
            </View>
          ) : null}
        </Section>
